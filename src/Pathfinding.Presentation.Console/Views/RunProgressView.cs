...
internal sealed partial class RunProgressView : FrameView
{
        ...
        IRunFieldViewModel viewModel)
    {
        ...
        BindTo(bar, _ => Fraction - GetFractionPerClick(), WheeledDown);
        BindTo(bar, _ => Fraction + GetFractionPerClick(), WheeledUp);
        BindTo(bar, _ => Fraction - GetExtraFractionPerClick(), WheeledDown | ButtonCtrl);
        BindTo(bar, _ => Fraction + GetExtraFractionPerClick(), WheeledUp | ButtonCtrl);
